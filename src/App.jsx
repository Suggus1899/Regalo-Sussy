        ...
        <div className="contenido">
          ...
          <main>
            <section className="seccion">
              ...
              <p className="animated-text">Y aunque sé que la vida es impredecible, hoy elijo creer en los finales felices. O, al menos, en los comienzos honestos. Porque contigo, incluso los silencios saben a verdad, y me alegra hacerte esto, pues es un hecho de que eres importante. Quiero hacerte saber eso, porque es la verdad, gracias por existir, gracias por estar y ser.</p>
              ...
              <p className="animated-text">Hasta entonces, seguiré atesorando cada "buenos días" tuyo como si fuera un tesoro. Es tu dia especial, se que no ha sido la mejor epoca, ni el mejor mes, pero este dia es de gran conmemoracion, porque naciste.</p>
